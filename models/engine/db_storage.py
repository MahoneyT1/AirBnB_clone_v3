...
class DBStorage:
    ...
    def __init__(self):
        ...
        HBNB_MYSQL_HOST = '100.26.53.35' #getenv('HBNB_MYSQL_HOST')
    ...
    def all(self, cls=None):
        ...
        if cls:
            ...
            for items in classes.values():
                result = self.__session.query(items).all()
    ...
    def count(self, cls=None):
        ...
        if cls:
            newlist_len =[]
            all_class = self.all(cls=cls)

            for i in all_class:
                newlist_len.append(i)
            return len(newlist_len)
